...
public class DoorcutterScreen extends HandledScreen<DoorcutterScreenHandler> {
    ...
    public DoorcutterScreen(DoorcutterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawMouseoverTooltip(MatrixStack matrices, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<DoorcuttingRecipe> list = this.handler.getAvailableRecipes();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (this.canCraft) {
            ...
            for (int l = this.scrollOffset; l < k; ++l) {
                ...
                if (!(d >= 0.0) || !(e >= 0.0) || !(d < 16.0) || !(e < 18.0) || !this.handler.onButtonClick(this.client != null ? this.client.player : null, l)) continue;
