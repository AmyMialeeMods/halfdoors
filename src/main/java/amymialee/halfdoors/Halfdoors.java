...
public class Halfdoors implements ModInitializer {
    ...
    public static final Item DOOR_FLIPPER = registerItem("door_flipper", new DoorFlipperItem(new FabricItemSettings().maxCount(1).maxDamage(80).rarity(Rarity.RARE).group(DOOR_GROUP)));
